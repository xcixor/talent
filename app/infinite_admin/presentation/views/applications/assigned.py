...
class AssignedApplicationsView(ListView):

    model = Application
    context_object_name = 'applications'
    template_name = 'infinite_admin/applications/assigned.html'
    partial_template_name = 'infinite_admin/applications/partials/assigned.html'
    paginate_by = 10
